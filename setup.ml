...
(* OASIS_START *)
(* DO NOT EDIT (digest: a4f29fc54dbf3e96baa22d253d93ce11) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xs_transport_lwt_unix_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\149h\150#\174Lf\019\136\015\001+\212\187\252\207";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
