...
(* OASIS_START *)
(* DO NOT EDIT (digest: b08c9fc9099ce6cf5804aba949f0c7aa) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "xenstore_transport_lwt_unix";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\012\\\026\t\140\018\148m\180\172?d\003n\227\255";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
