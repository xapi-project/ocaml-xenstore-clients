...
(* OASIS_START *)
(* DO NOT EDIT (digest: d254fec203ef56ae62f4c04be7ef617e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("xenstore", None)];
                   ...
                   {
                      lib_modules = ["Xs_transport"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xenstore_transport";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xenstore_transport_lwt_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "xenstore_transport";
                   ...
                   {
                      lib_modules = ["Xs_transport_lwt_unix_client"; "Xs"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore_transport";
               ...
               Library
                 ({
                     cs_name = "xenstore_transport_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Xs_transport_unix_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore_transport";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xenstore.client", None);
                           InternalLibrary "xenstore_transport";
                           InternalLibrary "xenstore_transport_lwt_unix";
                           FindlibPackage ("lwt.syntax", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xenstore.client", None);
                           InternalLibrary "xenstore_transport";
                           InternalLibrary "xenstore_transport_unix"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "I\131\007\155\147\158<\218\148Y\238\150\139\024\215|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
